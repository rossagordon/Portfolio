    ...
    <div name="projects" className="bg-[#E5E5E5v] w-full text-black">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full">
        <div className="pb-8">
          ...
          <p className="py-6 text-xl">Here are a few landing pages I've made:</p>
        </div>

        {/* Projects */}
        <div className="grid sm:grid-cols-2  md:grid-cols-3 gap-4 mt-[-20px] text-black">
          {/* Project 1 • Edgewood Contracting */}
          <div className="rounded-md shadow-lg bg-[#fff]">
            ...
            <div className="px-6 py-4 text-center">
              <div className="font-bold text-xl mb-2 text-center">Edgewood Contracting</div>
              <p className="pb-2">Description</p>
              <p className="font-extrabold">Technologies Used:</p>
            ...
            <div className="text-center mt-5">
              ...
              <a
                href="https://github.com/rossagordon/Edgewood-Contracting" target="_blank"
              >
                <button className="text-center rounded-lg px-2 py-2 m-2 bg-[#fff] text-[#000] border font-bold text-lg hover:bg-[#000] hover:text-[#fff]">
                  Code
                </button>
          ...
          <div className="rounded-md shadow-lg bg-[#fff]">
            ...
            <div className="px-6 py-4 text-center">
              <div className="font-bold text-xl mb-2 text-center">Lotus of my Heart</div>
              <p className="pb-2">Description</p>
              <p className="font-extrabold">Technologies Used:</p>
              <p>React • Tailwind CSS</p>
            </div>
            <div className="text-center mt-5">
              ...
              <a
                href="https://github.com/rossagordon/Lotus-of-My-Heart" target="_blank"
              >
                <button className="text-center rounded-lg px-2 py-2 m-2 bg-[#fff] text-[#000] border font-bold text-lg hover:bg-[#000] hover:text-[#fff]">
                  Code
                </button>
          ...
          <div className="rounded-md shadow-lg bg-[#fff]">
            ...
            <div className="px-6 py-4 text-center">
              <div className="font-bold text-xl mb-2 text-center">Good Coffee</div>
              <p className="pb-2">Description</p>
              <p className="font-extrabold">Technologies Used:</p>
              <p>React • Tailwind CSS</p>
            </div>
